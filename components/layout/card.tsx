...
export default function Card(props: any) {
    ...
    return (
        ...
        <a href={`/manager/${id}`} className={`flex flex-col items-center justify-between ${ color || 'bg-white' } border border-gray-200 rounded-lg shadow md:flex-row w-full hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 mb-2`}>
